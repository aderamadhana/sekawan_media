...
<div class="col-md-12 content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= site_url('Pemesanan/doKonfirmasiPemesananPihakKedua') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="id_kendaraan" value="<?= $data->id_kendaraan?>" readonly>
                    <input type="hidden" class="form-control" name="status_konfirmasi_pihak_kedua" value="1">
